  ...
  const otherProducts = [
    {
      ...
      description: "Our Smart Solar Dryer revolutionizes post-harvest processing by combining greenhouse technology with intelligent monitoring systems.",
      icon: Sun,
      linkText: "Learn More"
    },
    {
      title: "Screenhouses",
      description: "To us buying a screenhouse is a partnership that ensures we provide farming solutions to help you succeed and grow.",
      icon: Wind,
      linkText: "Learn More"
    },
    {
      title: "Drip Irrigation kits",
      description: "Our drip irrigation kits are designed to provide a durable space to grow your vegetables, flowers and fruits all year round.",
      icon: Droplets,
      linkText: "Learn More"
    }
  ];
      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Innovative <span className="bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">Farming Solutions</span>
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Transforming agriculture with cutting-edge technology and sustainable practices
          </p>
        </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col space-y-3">
                    <button className={`bg-gradient-to-r ${product.gradient} text-white px-6 py-3 rounded-xl hover:shadow-xl transition-all duration-300 font-semibold transform hover:scale-105`}>
                      {product.buttonText}
                    </button>
                    <button className="text-green-600 hover:text-green-700 font-semibold group/link flex items-center justify-center gap-2 transition-all duration-300">
                      {product.linkText}
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                We collaborate with leading organizations to bring innovative farming solutions to African farmers
              </p>
            </div>
