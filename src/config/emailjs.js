...
const EMAILJS_SERVICE_ID = "service_y0i2a2i"; // Replace with your EmailJS service ID
const EMAILJS_TEMPLATE_ID_CONTACT = "template_8qlfkjr"; // Replace with your contact template ID
const EMAILJS_TEMPLATE_ID_PRICE_ESTIMATE = "template_35kvuyk"; // Replace with your price estimate template ID
const EMAILJS_TEMPLATE_ID_DEMO_BOOKING = "template_demo_booking"; // Replace with your demo booking template ID
const EMAILJS_PUBLIC_KEY = "HdYgZxLdVeEqbovvN"; // Replace with your EmailJS public key
